...
# this took me much longer to figure out then i care to admit...
lcm = 1
for div in divs:
    lcm *= (lcm*div) // math.gcd(lcm, div)
print(lcm)
...
for r in range(rounds):
    for monkey in monkey_dict.values():
        ...
        monkey['Worry'] = [num%lcm for num in monkey['Worry']]
